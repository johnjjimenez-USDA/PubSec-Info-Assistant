...
module "storage" {
  ...
  containers     = ["content", "website", "upload", "function", "logs", "config", "metadata"]
...
module "enrichmentApp" {
  ...
  appSettings = {
    ...
    COSMOSDB_METADATA_DATABASE_NAME        = module.cosmosdb.CosmosDBMetadataDatabaseName
    COSMOSDB_METADATA_CONTAINER_NAME       = module.cosmosdb.CosmosDBMetadataContainerName
...
module "functions" {
  ...
  CosmosDBMetadataDatabaseName          = module.cosmosdb.CosmosDBMetadataDatabaseName
  CosmosDBMetadataContainerName         = module.cosmosdb.CosmosDBMetadataContainerName
...
module "cosmosdb" {
  ...
  metadataDatabaseName         = "metadatadb"
  metadataContainerName        = "metadatacontainer"
  resourceGroupName            = azurerm_resource_group.rg.name
  key_vault_name               = module.kvModule.keyVaultName
  is_secure_mode               = var.is_secure_mode
